...
fn main() -> io::Result<()> {
    ...
    for i in 0..10000 {
        ...
        while !s.is_empty() {
            ...
            // multiply 1+these values together. Drawing out my diagram's output 
            // and reverse engineering tells me that it's an or of these pulse values
